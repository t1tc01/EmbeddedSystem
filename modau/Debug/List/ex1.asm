...
_main:
; .FSTART _main
; 0000 0011 //DDRD.6 = 1; // Tac dong thanh ghi DDR vao PORT D bit 5 gia tri (N=1) de quy uoc no la loi ra
; 0000 0012 
; 0000 0013 //DDRD = 0x70;
; 0000 0014 
; 0000 0015 while (1)
...
; 0000 001D     DDRD = 0x70;
	LDI  R30,LOW(112)
	OUT  0x11,R30
; 0000 001E     PORTD = 0x70;
	OUT  0x12,R30
; 0000 001F     delay_ms(500);
	LDI  R26,LOW(500)
	LDI  R27,HIGH(500)
	CALL _delay_ms
; 0000 0020     PORTD = 0x20;
	LDI  R30,LOW(32)
	OUT  0x12,R30
