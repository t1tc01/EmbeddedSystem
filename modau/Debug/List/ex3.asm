...
; .FSTART _main
; 0000 001C //DDR (PB2) = 0
; 0000 001D DDRB = 0x00; //DDRB = 0b00000000;   vi tat ca cac bit nhan gia tri 0 nen B2 chac chan bang 0
	LDI  R30,LOW(0)
	OUT  0x17,R30
; 0000 001E //PORTB=0xFF; //pull up ca PORTB -> B2 kieu gi cung duoc Pull_up
; 0000 001F PORTB=0x04; // PORTB = 0b 0000 0100;
	LDI  R30,LOW(4)
	OUT  0x18,R30
; 0000 0020 DDRD=0x10;  // DDRD=0b 0001 0000; ?
	LDI  R30,LOW(16)
	OUT  0x11,R30
; 0000 0021 PORTD=0x00; //De cho toan bo cac bit trong PORTD = 0 -> den o PORTD bit 2 cung = 0 -> tat
	LDI  R30,LOW(0)
	OUT  0x12,R30
; 0000 0022 
; 0000 0023 while (1)
